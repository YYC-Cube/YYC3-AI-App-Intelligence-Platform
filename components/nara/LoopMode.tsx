  ...
  const [workflows, setWorkflows] = useState<Workflow[]>([
      ...
      steps: [
        {
          ...
          status: 'completed',
          duration: '1m 12s',
          outputKey: 'found_bottlenecks',
          outputParams: ['7'],
        },
        {
          id: '2',
          nameKey: 'code_refactor',
          status: 'completed',
          duration: '2m 34s',
          outputKey: 'optimized_comps',
          outputParams: ['14'],
        },
    ...
    },
    {
      ...
      steps: [
        {
          id: '1',
          nameKey: 'context_analysis',
          status: 'completed',
          duration: '23s',
          outputKey: 'analyzed_voice',
        },
        {
          id: '2',
          nameKey: 'draft_gen',
        ...
        },
        {
          ...
          status: 'completed',
          duration: '34s',
          outputKey: 'variants_passed',
        },
        {
          id: '4',
          nameKey: 'finalization',
          status: 'completed',
          duration: '12s',
          outputKey: 'ready',
        },
      ...
      steps: [
        {
          ...
          nameKey: 'cont_mon',
          status: 'running',
          outputKey: 'active_users',
          outputParams: ['1,247', '3,421'],
        },
      ],
    },
  ]);
        ...
        <div className="space-y-3">
          {workflows.map((workflow, index) => {
            ...
            const workflowName = String(
              t.workflows[workflow.nameKey as keyof typeof t.workflows] || workflow.nameKey
            );
            const typeName = String(
              t.types[workflow.type as keyof typeof t.types] || workflow.type
            );
              ...
              >
                ...
                >
                  <div className="flex items-center gap-4 mb-3">
                    <div
                      className={`w-10 h-10 rounded-xl bg-gradient-to-br ${getWorkflowTypeColor(workflow.type)} flex items-center justify-center flex-shrink-0 shadow-sm text-white`}
                    >
                  ...
                  <div className="space-y-1.5">
                    <div className="flex items-center justify-between text-xs font-medium">
                      ...
                      {workflow.startTime && workflow.status === 'running' && (
                        <span className="text-slate-400 font-mono flex items-center gap-1">
                          ...
                          {Math.floor((Date.now() - workflow.startTime.getTime()) / 60000)}m{' '}
                          {Math.floor(((Date.now() - workflow.startTime.getTime()) % 60000) / 1000)}
                          s
                        </span>
                      )}
                    </div>
                    <div className="w-full bg-slate-100 rounded-full h-2 overflow-hidden">
                      <motion.div
                        ...
                        initial={{ width: 0 }}
                        animate={{
                          width: `${((workflow.currentStep || 0) / workflow.totalSteps) * 100}%`,
                        }}
                            ...
                            >
                              <div className="flex items-center gap-3 mb-2">
                                ...
                                <div className="flex-1">
                                  <div
                                    className={`text-sm font-semibold ${step.status === 'running' ? 'text-blue-700' : 'text-slate-700'}`}
                                  >
                                    {stepName}
                                  </div>
                                  {step.duration && (
