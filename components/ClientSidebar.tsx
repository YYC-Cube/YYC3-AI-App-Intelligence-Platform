...
const moduleGroups = [
  {
    title: 'Revenue',
    modules: [
      { id: 'dashboard', label: 'Revenue Dashboard', icon: Home, badge: null },
      { id: 'financing', label: 'App Financing', icon: Wallet, badge: 'Investment' },
      { id: 'pricing', label: 'Pricing Strategy', icon: DollarSign, badge: null },
    ],
  },
  {
    title: 'Analytics',
    modules: [
      { id: 'explorer', label: 'App Analytics', icon: Search, badge: null },
  ...
  },
  {
    ...
    modules: [
      ...
      { id: 'ui-ux', label: 'UI/UX Analysis', icon: Smartphone, badge: null },
    ],
  },
  {
...
export function ClientSidebar({ activeModule, onModuleChange }: ClientSidebarProps) {
      ...
      <div className="p-6 border-b border-sidebar-border">
        ...
        <div className="bg-sidebar-accent rounded-lg p-3">
          <div className="flex items-center justify-between mb-1">
            <span className="font-medium text-sm text-sidebar-accent-foreground">
          ...
          <p className="text-xs text-sidebar-accent-foreground/70">Moneyball meets with AlphaGo</p>
        </div>
      </div>
                            ...
                            : module.badge === 'New'
                              ...
                              : module.badge === 'AI'
                                ...
                                : module.badge === 'Live'
                                  ...
                                  : module.badge === 'Amplify'
                                    ? 'bg-gradient-to-r from-purple-100 to-cyan-100 text-purple-800'
                                    : ''
                        }`}
                      >
                        {module.badge}
