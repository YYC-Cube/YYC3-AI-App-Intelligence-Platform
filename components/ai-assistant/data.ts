/**
 * @fileoverview YYC³ AI Assistant - 所有常量数据
 * @description Adapted from docs/AI-Dev/AIAssistant/data.ts — v3.0
 * @version 1.0.0
 * @author YYC³ Team
 */
import {
...
export const FAMILY_PERSONAS: AiFamilyPersona[] = [
  {
    id: 'navigator',
    name: '言启·千行',
    shortName: '千行',
...
export const SYSTEM_COMMANDS: (SystemCommand & { persona?: string })[] = [
  {
    ...
    label: '集群状态总览',
    desc: '获取所有节点实时状态',
    category: 'cluster' as CommandCategory,
  ...
  },
  {
    ...
    category: 'data' as CommandCategory,
  ...
  },
  {
    ...
    label: '网络延迟诊断',
    desc: '诊断节点间网络延迟',
    category: 'monitor' as CommandCategory,
...
export const AI_SKILLS: AISkill[] = [
  {
    id: 'skill-01',
    name: '语义理解',
    description: '自然语言意图识别、实体抽取、上下文理解',
    icon: Search,
    category: 'nlp',
    color: '#00d4ff',
    active: true,
  },
  {
    id: 'skill-02',
    name: '数据洞察',
    description: '多维数据分析、趋势识别、异常模式发现',
    icon: BarChart3,
    category: 'analytics',
    color: '#FF69B4',
    active: true,
  ...
  },
  {
    id: 'skill-04',
    name: '创意创作',
    description: '文案生成、UI设计建议、多模态内容创作',
    icon: Palette,
    category: 'creative',
    color: '#FF7043',
    active: true,
...
export const AI_PLUGINS: AIPlugin[] = [
  ...
  },
  {
    id: 'plug-02',
    name: '文档解析',
    description: 'PDF/DOCX/图片文字提取与分析',
    version: '1.8.3',
    icon: Search,
    color: '#FF69B4',
    category: 'data',
