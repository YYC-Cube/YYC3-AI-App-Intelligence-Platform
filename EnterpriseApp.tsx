...
import type { AppContext, AppData } from './types';
...
export default function EnterpriseApp() {
  ...
  const getModuleInfo = (moduleId: string, subPageId?: string) => {
    const moduleMap = {
      ...
      'owner-dashboard': {
        title:
          subPageId === 'cost-management'
            ? 'Cost Management'
            : subPageId === 'performance-analytics'
              ? 'Performance Analytics'
              : 'Owner Dashboard',
        subtitle:
          subPageId === 'cost-management'
            ? 'Interactive cost analysis and budget management'
            : subPageId === 'performance-analytics'
      ...
      explorer: {
        ...
        subtitle:
          subPageId === 'detail'
            ...
            : 'Discover and analyze mobile applications',
      },
      trends: {
      ...
      'growth-capital': {
        title:
          subPageId === 'investment-detail'
            ? 'Investment Analysis'
            : subPageId === 'fund-management'
              ? 'Fund Management'
              : 'Growth Capital',
        subtitle:
          subPageId === 'investment-detail'
            ...
            : subPageId === 'fund-management'
              ? 'Capital deployment and fund operations'
              : 'Enterprise investment portfolio and capital management',
      },
        ...
        subtitle:
          subPageId === 'workspace'
            ...
            : subPageId === 'plan-builder'
              ...
              : 'Intelligence amplification system for strategic planning and growth',
      },
      markets: {
        title:
          subPageId === 'detail'
        ...
        subtitle:
          subPageId === 'pipeline'
            ...
            : subPageId === 'lead-generation'
              ...
              : 'Sales pipeline and lead generation intelligence',
      },
      learning: {
        title:
          subPageId === 'analytics'
  ...
  const renderModule = () => {
    const moduleProps = {
      ...
      appContext: { selectedApp: null } as AppContext,
    };
