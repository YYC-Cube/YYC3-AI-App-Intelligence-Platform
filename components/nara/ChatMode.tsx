...
export function ChatMode({ language }: ChatModeProps) {
  ...
  useEffect(() => {
    ...
    // Reset sessions when language changes for demo purposes — full t object intentionally omitted
          ...
          return (
            ...
            >
              ...
              >
                ...
                <Folder
                  className={`w-4 h-4 bg-gradient-to-r ${project.color} bg-clip-text text-transparent fill-current opacity-80`}
                />
                <span className="text-sm font-semibold flex-1 text-left text-slate-700">
                  {projectName}
                </span>
          ...
          {activeSession?.messages.map((message) => (
            ...
            >
              ...
              >
                ...
                <div
                  className={`flex items-center gap-2 mt-2 ${message.role === 'user' ? 'justify-end text-slate-400' : 'text-slate-400'}`}
                >
